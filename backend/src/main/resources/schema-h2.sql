...
-- H2 nie wspiera indeksów częściowych (WHERE)
-- Ograniczenie "tylko jeden aktywny wynajem na klienta" jest egzekwowane w warstwie aplikacji
...
-- H2 nie wspiera indeksów częściowych (WHERE)
-- Ograniczenie "tylko 1 aktywny karnet na usera" jest egzekwowane w warstwie aplikacji
